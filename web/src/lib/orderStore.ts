...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'Sides',
    description: 'Crispy golden fried plantain slices, perfect as a side dish.',
    price: 400,
    originalPrice: 500,
  ...
  },
  {
    ...
    category: 'Snacks',
    description: 'Soft, sweet, deep-fried West African doughnuts — campus favourite.',
    price: 300,
  ...
  },
  {
    ...
    category: 'Snacks',
    description: 'Hot, crispy deep-fried bean cakes — the ultimate campus breakfast snack.',
    price: 250,
